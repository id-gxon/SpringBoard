				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#">
						...
						<ul class="treeview-menu">
							...
							<li><a href="../layout/fixed.html">
									<i class="fa fa-circle-o"></i> Fixed
								</a></li>
							<li><a href="../layout/collapsed-sidebar.html">
					...
					<li class="treeview"><a href="#">
						...
						<ul class="treeview-menu">
							...
							<li><a href="../UI/sliders.html">
									<i class="fa fa-circle-o"></i> Sliders
								</a></li>
							<li><a href="../UI/timeline.html">
					...
					<li class="treeview"><a href="#">
						...
						<ul class="treeview-menu">
							...
							<li><a href="../examples/404.html">
									<i class="fa fa-circle-o"></i> 404 Error
								</a></li>
							<li><a href="../examples/500.html">
